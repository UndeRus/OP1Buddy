...
class DrumkitRepositoryImpl(private val context: Context, private val json: Json): DrumkitRepository {
    override fun loadDrumKit(projectPath: String, fileName: String): DrumkitInfo? {
